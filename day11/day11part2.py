...
def getNextPasswd( current ):
    newp = incrementPassword( current )
    while not isCorrect( newp ):
        newp = incrementPassword( newp )
    return newp
...
def main( argv ):
    ...
    puzzle = getNextPasswd( puzzle )
    print "First passwd:", puzzle
    
    puzzle = getNextPasswd( puzzle )
    print "Second passwd:", puzzle
